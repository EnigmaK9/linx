...
def fetch_and_display_data():
    ...
    # Execute SQL query to select all records from the comms_437_mhz_tx table, limited to the first 100 records
    cursor.execute('select * from comms_437_mhz_tx limit 100')
    ...
    print("-" * 125)  # Print a divider line for clarity
